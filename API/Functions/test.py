...
a = [{"vals": {"publicIp": "103.215.44.132", "protocol": "TCP", "name": "IPservpn", "privatePort": 4009,
      ...
      "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
         ...
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "103.215.44.156", "protocol": "TCP", "name": "mail-company-dx04", "privatePort": 80,
         ...
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "103.215.44.156", "protocol": "TCP", "name": "mail-company-dx05", "privatePort": 443,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "103.215.44.156", "name": "103.215.44.156"},
                                                          {"IP": "172.18.132.92", "name": "172.18.132.92"}],
                  "publicPort": 443, "privateIp": "172.18.132.92"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "112.93.114.77", "protocol": "TCP", "name": "mail-company-lt04", "privatePort": 80,
         ...
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "112.93.114.77", "protocol": "TCP", "name": "mail-company-lt05", "privatePort": 443,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "112.93.114.77", "name": "112.93.114.77"},
                                                          {"IP": "172.18.132.92", "name": "172.18.132.92"}],
                  "publicPort": 443, "privateIp": "172.18.132.92"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
         ...
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "117.48.196.142", "protocol": "TCP", "name": "company-iot-zhyc-gateway-adapter.stage",
         ...
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "112.93.114.71", "protocol": "TCP", "name": "kafka_prod.company.com-9098_lt",
         ...
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "112.93.114.71", "protocol": "TCP", "name": "kafka.company.com-9097_lt",
                  "privatePort": 9092,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "112.93.114.71", "name": "112.93.114.71"},
         ...
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "103.215.44.150", "protocol": "TCP", "name": "kafka.company.com-9097", "privatePort": 9092,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "103.215.44.150", "name": "103.215.44.150"},
                                                          {"IP": "172.18.32.11", "name": "172.18.32.11"}],
                  "publicPort": 7071, "privateIp": "172.18.32.11"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "103.215.44.150", "protocol": "TCP", "name": "kafka.company.com-9098", "privatePort": 9092,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "103.215.44.150", "name": "103.215.44.150"},
                                                          {"IP": "172.18.32.12", "name": "172.18.32.12"}],
                  "publicPort": 7072, "privateIp": "172.18.32.12"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "103.215.44.150", "protocol": "TCP", "name": "kafka.company.com-9099", "privatePort": 9092,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "103.215.44.150", "name": "103.215.44.150"},
                                                          {"IP": "172.18.32.13", "name": "172.18.32.13"}],
                  "publicPort": 7073, "privateIp": "172.18.32.13"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "103.215.44.156", "protocol": "TCP", "name": "mail-company-dx01", "privatePort": 110,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "103.215.44.156", "name": "103.215.44.156"},
                                                          {"IP": "172.18.129.10", "name": "172.18.129.10"}],
                  "publicPort": 110, "privateIp": "172.18.129.10"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "103.215.44.156", "protocol": "TCP", "name": "mail-company-dx02", "privatePort": 143,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "103.215.44.156", "name": "103.215.44.156"},
                                                          {"IP": "172.18.129.10", "name": "172.18.129.10"}],
                  "publicPort": 143, "privateIp": "172.18.129.10"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "103.215.44.156", "protocol": "TCP", "name": "mail-company-dx07", "privatePort": 465,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "103.215.44.156", "name": "103.215.44.156"},
                                                          {"IP": "172.18.129.10", "name": "172.18.129.10"}],
                  "publicPort": 465, "privateIp": "172.18.129.10"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "103.215.44.156", "protocol": "TCP", "name": "mail-company-dx08", "privatePort": 993,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "103.215.44.156", "name": "103.215.44.156"},
                                                          {"IP": "172.18.129.10", "name": "172.18.129.10"}],
                  "publicPort": 993, "privateIp": "172.18.129.10"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "103.215.44.156", "protocol": "TCP", "name": "mail-company-dx03", "privatePort": 25,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "103.215.44.156", "name": "103.215.44.156"},
                                                          {"IP": "172.18.129.10", "name": "172.18.129.10"}],
                  "publicPort": 25, "privateIp": "172.18.129.10"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "103.215.44.156", "protocol": "TCP", "name": "mail-company-dx06", "privatePort": 995,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "103.215.44.156", "name": "103.215.44.156"},
                                                          {"IP": "172.18.129.10", "name": "172.18.129.10"}],
                  "publicPort": 995, "privateIp": "172.18.129.10"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "112.93.114.77", "protocol": "TCP", "name": "mail-company-lt01", "privatePort": 110,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "112.93.114.77", "name": "112.93.114.77"},
                                                          {"IP": "172.18.129.10", "name": "172.18.129.10"}],
                  "publicPort": 110, "privateIp": "172.18.129.10"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "112.93.114.77", "protocol": "TCP", "name": "mail-company-lt02", "privatePort": 143,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "112.93.114.77", "name": "112.93.114.77"},
                                                          {"IP": "172.18.129.10", "name": "172.18.129.10"}],
                  "publicPort": 143, "privateIp": "172.18.129.10"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "112.93.114.77", "protocol": "TCP", "name": "mail-company-lt03", "privatePort": 25,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "112.93.114.77", "name": "112.93.114.77"},
                                                          {"IP": "172.18.129.10", "name": "172.18.129.10"}],
                  "publicPort": 25, "privateIp": "172.18.129.10"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "112.93.114.77", "protocol": "TCP", "name": "mail-company-lt06", "privatePort": 995,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "112.93.114.77", "name": "112.93.114.77"},
                                                          {"IP": "172.18.129.10", "name": "172.18.129.10"}],
                  "publicPort": 995, "privateIp": "172.18.129.10"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "112.93.114.77", "protocol": "TCP", "name": "mail-company-lt07", "privatePort": 465,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "112.93.114.77", "name": "112.93.114.77"},
                                                          {"IP": "172.18.129.10", "name": "172.18.129.10"}],
                  "publicPort": 465, "privateIp": "172.18.129.10"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "112.93.114.77", "protocol": "TCP", "name": "mail-company-lt08", "privatePort": 993,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "112.93.114.77", "name": "112.93.114.77"},
                                                          {"IP": "172.18.129.10", "name": "172.18.129.10"}],
                  "publicPort": 993, "privateIp": "172.18.129.10"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
         ...
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "112.93.114.71", "protocol": "TCP", "name": "kafka.company.com-9098_lt",
                  "privatePort": 9092,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "112.93.114.71", "name": "112.93.114.71"},
                                                          {"IP": "172.18.32.12", "name": "172.18.32.12"}],
                  "publicPort": 7072, "privateIp": "172.18.32.12"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "112.93.114.71", "protocol": "TCP", "name": "kafka.company.com-9099_lt",
                  "privatePort": 9092,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "112.93.114.71", "name": "112.93.114.71"},
                                                          {"IP": "172.18.32.13", "name": "172.18.32.13"}],
                  "publicPort": 7073, "privateIp": "172.18.32.13"},
         ...
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "117.48.196.150", "protocol": "TCP", "name": "kafka.company.com-9097_BGP",
                  "privatePort": 9092,
         ...
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "117.48.196.150", "protocol": "TCP", "name": "kafka.company.com-9098_BGP",
                  "privatePort": 9092,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "117.48.196.150", "name": "117.48.196.150"},
                                                          {"IP": "172.18.32.12", "name": "172.18.32.12"}],
                  "publicPort": 7072, "privateIp": "172.18.32.12"},
         "dims": {"pks": ["name", "publicIp", "privateIp", "protocol", "publicPort", "privatePort", "firewall"],
                  "object_id": "SERVER_MAPPING", "upsert": false}}, {
         "vals": {"publicIp": "117.48.196.150", "protocol": "TCP", "name": "kafka.company.com-9099_BGP",
                  "privatePort": 9092,
                  "firewall": "172.18.0.6", "IPADDRESS": [{"IP": "117.48.196.150", "name": "117.48.196.150"},
                                                          {"IP": "172.18.32.13", "name": "172.18.32.13"}],
                  "publicPort": 7073, "privateIp": "172.18.32.13"},
